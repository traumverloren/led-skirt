...
void connect() {
  ...
  Serial.print("\nconnecting...");
  while (!client.connect("led-skirt", "key", "token")) {
    Serial.print(".");
    delay(1000);
  }
  ...
  for(int x=0; x < stripCount; x++) {
    for(uint16_t i=0; i<ledCount; i++) {
      if (count < 12) {
         ...
         strip_2.setPixelColor(10-i, strip_1.Color(75, 250, 100, 0)); // Draw 'head' pixel
         ...
         strip_4.setPixelColor(10-i, strip_1.Color(75, 250, 100, 0)); // Draw 'head' pixel      
        ...
        strip_6.setPixelColor(10-i, strip_1.Color(75, 250, 100, 0)); // Draw 'head' pixel 
      }
      count++;
      showStrips();
      delay(50);
